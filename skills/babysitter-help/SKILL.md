...
/babysitter-yolo [input]
  Start a babysitter run in fully autonomous mode. Identical to /babysitter-call but all breakpoints
  ...
  How it works: Same orchestration as /babysitter-call, but the process context is configured to
...
/babysitter-plan [input]
  ...
  You get a complete plan you can review, modify, or execute later with /babysitter-call.
...
/babysitter-retrospect [run id or name]
  ...
  implementation of changes, and routing to /babysitter-contrib if improvements belong in the
...
/babysitter-observe
  ...
  effect status in your browser. Useful when running /babysitter-yolo or /babysitter-forever to watch
